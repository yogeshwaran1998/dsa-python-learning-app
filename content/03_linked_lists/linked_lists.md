...
A node holds a value and a pointer to the next node. The last node points to `null`.
...
<div class="dsa-diagram dsa-diagram--center">
  ...
  <span class="darrow">&rarr;</span>
  <div class="dnode">
    <span class="dcell">2</span>
    <span class="dcell dcell--label">next</span>
  </div>
  <span class="darrow darrow--muted">&rarr;</span>
  <div class="dnode dnode--null"><span class="dcell">null</span></div>
  <div class="dsa-caption">Singly linked list: each node stores a value and a pointer to the next node.</div>
</div>
