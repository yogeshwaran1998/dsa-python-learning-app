...
A queue is **FIFO** (first in, first out): elements leave from the front in the order they arrived at the rear.

<div class="dsa-diagram dsa-diagram--center">
  <span class="darrow darrow--muted">front&nbsp;&rarr;</span>
  <div class="dnode dnode--highlight"><span class="dcell">1</span></div>
  <div class="dnode"><span class="dcell">2</span></div>
  <div class="dnode"><span class="dcell">3</span></div>
  <div class="dnode"><span class="dcell">4</span></div>
  <span class="darrow darrow--muted">&larr;&nbsp;rear</span>
  <div class="dsa-caption">dequeue removes 1 (the front); enqueue appends at the rear. Both O(1).</div>
</div>
